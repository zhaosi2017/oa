...
$this->title = '任务备注';
$this->params['breadcrumbs'][] = ['label'=>'任务','url'=>'/task/task/sent-index'];
$this->params['breadcrumbs'][] = ['label' => '已发任务', 'url' => ['/task/task/sent-index']];
...
<div class="task-index">
    <p class="btn-group hidden-xs">
        <?= Html::a('任务信息', ['/task/task/sent-detail','id'=>$model->id], ['class' => 'btn btn-outline btn-default']) ?>
        ...
        <?= Html::a('任务备注', ['/task/remark/index','id'=>$model->id], ['class' =>  'btn btn-primary']) ?>
    </p>
    <table class="table table-bordered">
        ...
        <tr>
            <td>
                <div class="btn-group">
                    <?= Html::a('备注列表', ['index','id'=>$model->id], ['class' => $actionId=='index' ? 'btn btn-primary' : 'btn btn-outline btn-default']) ?>
