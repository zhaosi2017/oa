...
<div class="task-index">
    <p class="btn-group hidden-xs">
        ...
        <?= Html::a('执行反馈', ['/task/feedback/index','id'=>$model->id], ['class' =>  'btn btn-primary']) ?>
        ...
        <table class="table table-bordered">
            ...
            <tr>
                <td>
                    <div class="btn-group">
                        <?= Html::a('列表', ['index','id'=>$model->id], ['class' => $actionId=='index' ? 'btn btn-primary' : 'btn btn-outline btn-default']) ?>
